...
module.exports = exports = function (chai, _) {
  ...
  Assertion.addMethod('performance', function (params, done) {
    ...
    function complete (single, av, paramsx, total, singlex) {
      console.log('hey hey'.green, single, av, paramsx, total, singlex)
      perfAssert(
    ...
    if (compare) {
      performance(compare, function (single, av, paramsx, total, singlex) {
        ...
        params.time = typeof single === 'object'
          ? singlex
          : single
